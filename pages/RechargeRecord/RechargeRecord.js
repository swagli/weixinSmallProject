...
Page({
  ...
  getRedlist: function (customerId, pageIndex, pageSize){//获取支付记录
    var _this = this;
    var url = constant.getPaymentRecords(customerId, pageIndex, pageSize);
  ...
  getHistoryLIst: function (customerId, pageIndex, pageSize) {//获取常用地址列表
    var _this = this;
    var url = constant.getRechargeRecords(customerId, pageIndex, pageSize);
    //请求数据
    requestToken.tokenAjaxGet({
      url: url,
      success(res) {

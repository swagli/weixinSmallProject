...
Page({
   ...
   */
  data: {
    web_src: ctxPath + "/agent/views/businessmanSpread.html?businessmanId="//接受要跳转的路径
  },
  ...
  onLoad: function (options) {
    ...
    if (scene){
      var return_url = ctxPath + "/agent/views/businessmanSpread.html?businessmanId=" + scene;
  ...
  onShareAppMessage: function (options) {
    ...
    if (options.webViewUrl) {
      ...
      let return_url = ctxPath + "/agent/views/businessmanSpread.html&businessmanId=123";
    }
    console.log("分享的URl");
